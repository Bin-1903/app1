        ...
        <>
            ...
            <section className="w-full flex-grow">
                <section className="mx-auto w-full my-6 grid max-w-[1200px] grid-cols-1 gap-3 px-5 pb-10 lg:grid-cols-3 lg:pt-10">
                    ...
                    {/* Repeat similar blocks for "Support" and "Careers" */}
                </section>
                ...
                {/* Form Section */}
                <form className="mx-auto my-5 max-w-[600px] px-5 pb-10">
                    ...
                    <select className="mb-3 w-full border px-4 py-2" name="category">
                    ...
                    <div className="lg:items:center container mt-4 flex flex-col justify-between lg:flex-row">
                        <div className="flex items-center">
                            <input className="mr-3" type="checkbox" id="termsCheckbox" />
